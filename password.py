...
popup_Label = Label(root, text="Complexity:")
popup_Label.grid(column=0, row=20)
popup_Label_field = Entry()
popup_Label_field.grid(column=1, row=20)
popup = Button(root, text="Generate a password", command=generatePasswordPopup)
popup.grid(column=2, row=20)
...
popup_Label.configure(fg="white", bg="black")
popup_Label_field.configure(fg="white", bg="black")
popup.configure(fg="white", bg="black")
